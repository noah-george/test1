...
class Server:
    ...
    """
    def __init__(self, vad_pipeline, asr_pipeline, host='localhost', port=8765, sampling_rate=16000, samples_width=2,initial_config="faster_whisper"):
        ...
        self.asr_type=initial_config["asr_type"]
        print(self.asr_type)
